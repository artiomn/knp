 ...
 *
 * @details The literal `name` is the key under which a string tag is placed in the object's @ref core::TagMap. It is used 
 ...
 * as a string in the object's @ref core::TagMap.
 */
template <typename Type>
