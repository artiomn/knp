...
public:  // NOLINT
     ...
     */
    void set_neuron_parameters(size_t index, NeuronParameters const &parameters) { neurons_[index] = parameters; }
     ...
     * @note Copy method.
     */
    void set_neurons_parameters(std::vector<NeuronParameters> const &parameters) { neurons_ = parameters; }
