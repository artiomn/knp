...
void export_resource_stdp_delta()
{
    py::class_<rds_rule>(
        ...
        "Delta synapse parameters with support of synaptic resource-based STDP.")
        .def(py::init<>())
        .add_property(
        ...
        .add_property(
            "last_spike_step", &rds_rule::last_spike_step_, "Step number of when the synapse got a spike last.")
        .add_property(
